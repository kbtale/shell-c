...
static const char *builtins_list[] = {
    ...
    "clear", "cls", "ping", "read", "touch", "banner", "whoami", "ip", "cat", "cp", "price", "convert", "trending", "feargreed", "gas", "addrinfo", "balance", "whale", "tx", "block", "fees", "defi", "nft", "exchanges", "news", "halving"
};
