...
int builtin_help() {
    ...
    printf("  \033[1;32mgrep <p> <f>\033[0m: Search pattern in file\n");
    ...
    printf("  \033[1;32mrot13 <txt>\033[0m: Apply ROT13 cipher\n");
    printf("  \033[1;32mtype <cmd>\033[0m : Identify builtin or path\n");
    printf("  \033[1;32mwc <file>\033[0m  : Count lines, words, chars\n");
